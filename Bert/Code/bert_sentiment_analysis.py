...
Original file is located at
    https://colab.research.google.com/drive/1n28jddKQWn_DLLLmXDLCyQ2pU0KymM75
...
model.load_state_dict(torch.load('/content/finetuned_BERT_epoch_10.model', map_location=torch.device('cpu')))   #output file loc 
